       ...
       <div className=' pt-7 border-bottom'>
           <div className=' container'>
               <div className=' row pb-7'>
                   ...
                   <div className=' col-12 col-md-6 col-lg-3'>
                       <div className=' d-flex'>
                           <VscLock className=' text-primary'/>
                           <div className=' ms-3'>
                       ...
                       <div className="row">
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       ...
                                       <div className=' fw-semibold'>Leather mid-heel Sandals</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       ...
                                       <div className=' fw-semibold'>Cotton floral print Dress</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               ...
                               <div className=' card-badge sh-badge bg-black text-white text-uppercase px-2'>New</div>
                                   ...
                                   <div className=' sh-card-body'>
                                       <p className=' mt-3 text-black-50 mb-0'>Shoes</p>
                                       <div className=' fw-semibold'>Leather Sneakers</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       ...
                                       <div className=' fw-semibold'>Cropped cotton Top</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       <p className=' mt-3 text-black-50 mb-0'>Dresses</p>
                                       <div className=' fw-semibold'>Floral print midi Dress</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       ...
                                       <div className=' fw-semibold'>Suede cross body Bags</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       ...
                                       <div className=' fw-semibold'>Printed A-line Skirt</div>
                           ...
                           <div className="col-6 col-md-4 col-lg-3">
                               <div className="sh-card mb-7" >
                                   ...
                                   <div className=' sh-card-body'>
                                       <p className=' mt-3 text-black-50 mb-0'>Shoes</p>
                                       <div className=' fw-semibold'>Heel strappy Sandals</div>
                   ...
                   <div className=' d-flex flex-column gap-4 mb-7' style={{width :' 80%'}}>
                       ...
                       <div className=' d-flex mb-5'>
                           <div className=' text-center'>
                               <h1 className=' text-primary fw-bolder'>{day}</h1><span className=' fw-medium text-black-50'> Days</span>
                           </div>
                           <div className=' px-3'>
                               <h2 className=' text-primary fw-bolder align-self-center'>:</h2>
                           </div>
                           <div className=' text-center'>
                               <h1 className=' text-primary fw-bolder'>{hour}</h1><span className=' fw-medium text-black-50'> Hour</span>
                           </div>
                           <div className=' px-3'>
                               <h2 className=' text-primary fw-bolder'>:</h2>
                           </div>
                           <div className=' text-center'>
                               <h1 className=' text-primary fw-bolder'>{minute}</h1><span className=' fw-medium text-black-50'>Minutes</span>
                           </div>
                           <div className=' px-3'>
                               <h2 className=' text-primary fw-bolder'>:</h2>
                           </div>
                           <div className=' text-center'>
                               <h1 className=' text-primary fw-bolder'>{sec}</h1><span className=' fw-medium text-black-50'>Seconds</span>
                           </div>
                       </div>
